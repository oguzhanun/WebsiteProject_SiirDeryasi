		...
		<div id="icerik" class="container ">
			...
			<div class="row justify-content-center">
				<div class="col-8 card mt-4 mx-2 p-0 text-white" style="background-color:black;">
					...
					<img class="card-img-top" src="https://images.pexels.com/photos/395196/pexels-photo-395196.jpeg?auto=compress&cs=tinysrgb&h=350">
			
					<div class="card-body ">
						<br>
						<h2 style="text-align:center" class="card-title">Sensiz Olmuyor</h2>
						<br>
